...
class Notifications extends REST_Controller
{
	...
	/**
	 * @api {post} /notifications/index Message is received
	 * @apiSampleRequest http://api.iamchill.co/v3/notifications/index
	 * @apiVersion 0.3.0
	 * @apiName Message is received
	 * @apiGroup Notifications
	 *
	 * @apiExample {curl} Example usage:
	 *    curl -i http://api.iamchill.co/v3/notifications/index
	 *
...
/* Location: ./application/controllers/v3/Notifications.php */